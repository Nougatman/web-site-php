...
--
-- Хост: localhost
-- Время создания: Ноя 21 2018 г., 07:57
...
INSERT INTO `city` (`id_cities`, `name_city`) VALUES
(1, 'Псков'),
(2, 'Киров'),
(3, 'Петроград'),
(4, 'Санкт-Петербург'),
...
INSERT INTO `trucks` (`id_trucks`, `statenumber`, `carrying`, `FIO_driver`) VALUES
(1, '712ЕКР102', 0.55, 'Петров Николай Андреевич'),
(2, '192РРР02', 1.5, 'Андреев Василий Степанович');
