...
--
-- Хост: localhost
-- Время создания: Ноя 30 2018 г., 17:28
...
(4, 'Лаврентьев Иван Тимурович', 89614600000);
...
INSERT INTO `traffics` (`id_traffics`, `customers`, `shipment`, `truck`, `city`, `street`, `delivery_date`) VALUES
(2, 1, 2, 1, 3, '3-ья Заводская, д.23', '2028-12-20'),
(4, 1, 2, 1, 5, 'ул.Пушкина, д.189', '2028-02-20');
...
(5, 'Камаз 6520', '612ЛКТ102', 20, 'Степанов Тимур Радмирович', 89324600000, 5.8, 2.2, 2.6, 'нет', 850),
(6, 'DAF 450', '560ЛУК41', 28, 'Артамонов Сергей Владиславович', 89996500000, 25, 2.7, 2.92, 'есть', 1560);
...
--
ALTER TABLE `cities`
  MODIFY `id_cities` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;
...
--
ALTER TABLE `shipments`
  MODIFY `id_shipments` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `trucks`
  MODIFY `id_trucks` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
